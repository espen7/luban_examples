...
enum class EMinorType(val value: Int) {
    // 钻石
    DIAMOND(101),
    // 金币
    GOLD(102),
...
;
    ...
    companion object {
        ...
        fun fromValue(value: Int): EMinorType? = valueMap[value]
        
        fun fromValueOrDefault(value: Int, default: EMinorType): EMinorType = valueMap[value] ?: default
    }
}
